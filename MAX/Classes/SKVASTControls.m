...
static const float kControlTimerInterval = 0.0;
static const float kSkipOffset = 5.0;
...
- (id)initWithVASTPlayer:(SKVASTViewController *)vastPlayer
{
    ...
    if (self) {
        ...
        // make toolbar slightly opaque gray with light gray text
        controlsToolbar.barStyle = UIBarStyleBlack;
        controlsToolbar.translucent = YES;
        controlsToolbar.backgroundColor = [UIColor clearColor];
        controlsToolbar.tintColor = [UIColor whiteColor];
        ...
        NSArray *toolbarButtons = @[fixedLeft, playbackTimeLabel, flexPlayback, stopButton];
        ...
        progressBar.tintColor = [UIColor darkGrayColor];
